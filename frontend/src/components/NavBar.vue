<template>
    <div class="header">
        <router-link @click="scrollToTop()" :to="isAdmin? '': '/'" class="logo"><img src="../assets/images/resi.jpg" alt="" />Hillstaurant
        </router-link>
 ...
 <!-- <div class="admin-logout-btn"> -->
    <nav class="navbar" v-if="isAdmin" style="width:50%">
                ...
                <router-link @click="handleLogout" to="/admin" v-if="isAdmin">logout</router-link>
            </nav>
        <!-- </div> -->
